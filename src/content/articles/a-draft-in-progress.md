...
It is committed to the repository like every other post — remember that in Go·Git CMS a save is already a commit, so "unpublished" cannot mean "unsaved". Publication has to be a property of the content, and that property is this flag.
